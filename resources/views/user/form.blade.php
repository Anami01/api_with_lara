    ...
    <table>
      ...
      <form action="{{ $url }}" method="post" enctype="multipart/form-data">@csrf @isset($edit_data) @method("PATCH") @endisset
        ...
        <tr>
          ...
          <td>
            <textarea name='address'>{{ isset($edit_data) ? $edit_data->address : '' }}</textarea>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="number" maxlength="10" value="{{ isset($edit_data) ? $edit_data->number : '' }}">
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            <input type="email" name="email" value="{{ isset($edit_data) ? $edit_data->email : '' }}">
          </td>
          <td>
            @if($errors->has('email')) 
        ...
        <tr>
          ...
          <td>
            <input type="password" name="password" value="{{ isset($edit_data) ? $edit_data->password : '' }}">
          </td>
          <td>
